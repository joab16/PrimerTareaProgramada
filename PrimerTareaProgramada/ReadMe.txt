========================================================================
    APLICACIÓN DE CONSOLA: PrimerTareaProgramada Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación PrimerTareaProgramada.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación PrimerTareaProgramada.


PrimerTareaProgramada.vcxproj
...
PrimerTareaProgramada.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado PrimerTareaProgramada.pch y un archivo de tipos precompilados llamado StdAfx.obj.
